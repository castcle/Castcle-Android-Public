...
class UserContentConverter {

    private val jsonType = object : TypeToken<UserContent>() {}.type

    @TypeConverter
    fun toUserContent(children: String): UserContent {
        return Gson().fromJson(children, jsonType)
    }

    @TypeConverter
    fun fromUserContent(children: UserContent): String {
