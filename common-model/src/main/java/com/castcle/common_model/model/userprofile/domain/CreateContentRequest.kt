package com.castcle.common_model.model.userprofile.domain
...
fun String.toCreateContentRequest(): CreateContentRequest {
    return Gson().fromJson(this, CreateContentRequest::class.java)
}

fun CreateContentRequest.toStringModel(): String {
