...
class ReplyConverter {
    ...
    private val jsonType = object : TypeToken<List<ReplyUiModel>>() {}.type

    @TypeConverter
    fun toChildren(children: String): List<ReplyUiModel> {
        return Gson().fromJson(children, jsonType)
    }

    @TypeConverter
    fun fromChildren(children: List<ReplyUiModel>): String {
