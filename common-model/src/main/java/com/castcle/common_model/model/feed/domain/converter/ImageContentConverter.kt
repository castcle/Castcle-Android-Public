...
class ImageContentConverter {
    ...
    private val jsonType = object : TypeToken<List<ImageContentUiModel>>() {}.type

    @TypeConverter
    fun toImageContentUiModel(children: String): List<ImageContentUiModel> {
        return Gson().fromJson(children, jsonType)
    }

    @TypeConverter
    fun fromImageContentUiModel(children: List<ImageContentUiModel>): String {
