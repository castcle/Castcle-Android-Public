...
import com.castcle.common_model.model.feed.api.response.LikedResponse
...
class LikedConverter {

    private val jsonType = object : TypeToken<LikedUiModel>() {}.type

    @TypeConverter
    fun toChildren(children: String): LikedUiModel {
        return Gson().fromJson(children, jsonType)
    }

    @TypeConverter
    fun fromChildren(children: LikedUiModel): String {
