...
import com.castcle.common_model.model.feed.AuthorUiModel
...
class AuthorConverter {
    ...
    private val jsonType = object : TypeToken<AuthorUiModel>() {}.type

    @TypeConverter
    fun toChildren(children: String): AuthorUiModel {
        return Gson().fromJson(children, jsonType)
    }

    @TypeConverter
    fun fromChildren(children: AuthorUiModel): String {
