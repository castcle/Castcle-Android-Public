...
import com.castcle.ui.search.viewholder.SearchTrendViewHolder
...
class SearchAdapter : RecyclerView.Adapter<SearchAdapter.ViewHolder<SearchUiModel>>(),
    DiffUpdateAdapter,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder<SearchUiModel> {
        return SearchTrendViewHolder.newInstance(parent, click)
    }
