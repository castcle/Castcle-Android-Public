...
import com.castcle.android.databinding.ItemSearchHasTagBinding
import com.castcle.common.lib.extension.subscribeOnClick
import com.castcle.common_model.model.search.SearchUiModel
import com.castcle.extensions.visibleOrInvisible
...
class SearchHasTagViewHolder(
    private val binding: ItemSearchHasTagBinding,
    ...
    override fun bindUiModel(uiModel: SearchUiModel) {
        ...
        if (uiModel is SearchUiModel.SearchHasTagUiModel)
            with(binding) {
                ...
                tvTrendCount.visibleOrInvisible(uiModel.isTrending)
            }
    }
    ...
    companion object {
        ...
        ): SearchHasTagViewHolder {
            val inflate = LayoutInflater.from(parent.context)
            val binding = ItemSearchHasTagBinding.inflate(inflate, parent, false)
            return SearchHasTagViewHolder(binding, clickItem)
        }
    }
}
