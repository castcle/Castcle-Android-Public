package com.castcle.ui.setting.notification.system
...
class SystemNotificationFragment : BaseFragment<NotificationFragmentViewModel>(),
    ...
    override fun initViewModel() {
        viewModel.fetchNotification("system")
    }
    ...
    private fun handleEmptyState(show: Boolean) {
        with(binding.empState) {
            visibleOrGone(show)
            bindUiState(EmptyState.NOTIFICATION_EMPTY)
        }
    }
