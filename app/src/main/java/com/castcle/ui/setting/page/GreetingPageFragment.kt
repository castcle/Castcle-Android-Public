package com.castcle.ui.setting.page
...
class GreetingPageFragment : BaseFragment<GreetingPageFragmentViewModel>(),
    ...
    override fun viewModel(): GreetingPageFragmentViewModel =
        ViewModelProvider(this, viewModelFactory)
            .get(GreetingPageFragmentViewModel::class.java)
    ...
    override fun bindViewEvents() {
        binding.btContinue.subscribeOnClick {
            navigateToCreateDisplayProfileFragment()
        }
    }

    private fun navigateToCreateDisplayProfileFragment() {
        onBoardNavigator.navigetToDisplayNameFragment(
            RegisterBundle.RegisterWithEmail(),true
        )
    }
