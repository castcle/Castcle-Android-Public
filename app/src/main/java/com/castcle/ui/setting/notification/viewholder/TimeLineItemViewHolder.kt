...
import com.castcle.android.databinding.ItemNotificationHeadLineBinding
...
class TimeLineItemViewHolder(
    private val binding: ItemNotificationHeadLineBinding,
    ...
    companion object {
        fun newInstance(
            ...
            val binding = ItemNotificationHeadLineBinding.inflate(inflate, parent, false)
            return TimeLineItemViewHolder(binding, clickItem)
        }
    }
}
