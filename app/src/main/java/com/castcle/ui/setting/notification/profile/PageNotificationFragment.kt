package com.castcle.ui.setting.notification.profile
...
class PageNotificationFragment : BaseFragment<NotificationFragmentViewModel>(),
    ...
    override fun initViewModel() {
        viewModel.fetchNotification("page")
    }
