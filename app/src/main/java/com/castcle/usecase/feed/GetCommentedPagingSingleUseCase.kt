...
import com.castcle.common_model.model.feed.CommentedModel
...
class GetCommentedPagingSingleUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val feedRepository: FeedRepository
) : SingleUseCase<CommentRequest, CommentedModel>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::RecastError
) {

    override fun create(input: CommentRequest): Single<CommentedModel> {
        return feedRepository.getCommentedPaging(input)
    }
}
