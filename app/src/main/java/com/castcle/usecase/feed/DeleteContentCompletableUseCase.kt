...
import com.castcle.common_model.model.feed.converter.DeleteContentRequest
...
class DeleteContentCompletableUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val feedRepository: FeedRepository
) : CompletableUseCase<DeleteContentCompletableUseCase.Input>(
    ...
    override fun create(input: Input): Completable {
        return feedRepository.deleteContent(
