...
class GetUserPageDataSingleUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val userPageDao: UserPageDao
) : SingleUseCase<Unit, List<UserPage>>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::Ignored
) {

    override fun create(input: Unit): Single<List<UserPage>> {
        return userPageDao.getUserPage()
    }
}
