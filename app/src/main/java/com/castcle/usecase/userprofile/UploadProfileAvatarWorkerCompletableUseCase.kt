...
//
//
//  Created by sklim on 20/10/2021 AD at 11:20.

class UploadProfileAvatarWorkerCompletableUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val userWorkerRepository: UserWorkerRepository
) : SingleUseCase<UserUpdateRequest, User>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::UpLoadAvatarError
) {

    override fun create(input: UserUpdateRequest): Single<User> {
        return userWorkerRepository
            .uppdateUserProfileWorker(input)
    }
}