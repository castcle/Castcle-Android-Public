...
class GetUserViewProfileSingleUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val userRepository: UserProfileRepository
) : FlowableUseCase<ViewProfileRequest, User>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::GetUserProfileError
) {
    override fun create(input: ViewProfileRequest): Flowable<User> {
        return userRepository.getViewProfileYou(input)
    }
}
