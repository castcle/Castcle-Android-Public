...
class UploadCastWithImageWorkerCompletableUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val castWithImageWorkerHelper: CastWithImageLoadWorkHelper,
) : CompletableUseCase<CreateContentRequest>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::UpLoadAvatarError
) {

    override fun create(input: CreateContentRequest): Completable {
        return Completable.fromAction {
            castWithImageWorkerHelper.uploadPost(input)
        }
    }
}
