...
class UpdateUserPageDataCompletableUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val userPageDao: UserPageDao
) : CompletableUseCase<List<UserPage>>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::Ignored
) {
    override fun create(input: List<UserPage>): Completable {
        return Completable.fromAction {
            userPageDao.insertAll(input)
        }
    }
}
