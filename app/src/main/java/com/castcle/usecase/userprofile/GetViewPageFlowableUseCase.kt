...
class GetViewPageFlowableUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val userRepository: UserProfileRepository
) : FlowableUseCase<String, User>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::GetUserProfileError
) {

    override fun create(input: String): Flowable<User> {
        return userRepository.getViewPage(input)
    }
}
