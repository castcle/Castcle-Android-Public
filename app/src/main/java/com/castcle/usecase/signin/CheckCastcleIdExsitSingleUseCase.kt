...
import com.castcle.common_model.model.signin.reuquest.CastcleIdRequest
...
class CheckCastcleIdExsitSingleUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val authenticationsRepository: AuthenticationsRepository
) : SingleUseCase<CastcleIdRequest, CastcleIdVerifyUiModel>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::Ignored
) {

    override fun create(input: CastcleIdRequest): Single<CastcleIdVerifyUiModel> {
        return authenticationsRepository
            .authCheckCastcleExsit(input)
    }
}
