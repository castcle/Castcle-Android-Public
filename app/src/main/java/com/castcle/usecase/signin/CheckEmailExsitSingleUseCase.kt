...
class CheckEmailExsitSingleUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val authenticationsRepository: AuthenticationsRepository
) : SingleUseCase<EmailRequest, EmailVerifyUiModel>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::Ignored
) {

    override fun create(input: EmailRequest): Single<EmailVerifyUiModel> {
        return authenticationsRepository
            .authCheckEmailExsit(input)
    }
}
