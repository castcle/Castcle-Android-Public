...
class SubmitChangePasswordUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val authenticationsRepository: AuthenticationsRepository
) : CompletableUseCase<ChangePassRequest>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::VerificationError
) {
    override fun create(input: ChangePassRequest): Completable {
        return authenticationsRepository.authChangePasswordSubmit(input)
    }
}
