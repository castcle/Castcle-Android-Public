...
class GetVerificationPassSingleUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val authenticationsRepository: AuthenticationsRepository
) : SingleUseCase<String, VerificationUiModel>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    ::VerificationError
) {
    override fun create(input: String): Single<VerificationUiModel> {
        return authenticationsRepository.authVerificationPassword(input)
    }
}
