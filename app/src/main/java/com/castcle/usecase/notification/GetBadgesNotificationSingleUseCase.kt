package com.castcle.usecase.notification
...
class GetBadgesNotificationSingleUseCase @Inject constructor(
    rxSchedulerProvider: RxSchedulerProvider,
    private val notificationRepository: NotificationRepository
) : SingleUseCase<Unit, NotificationUiModel>(
    rxSchedulerProvider.io(),
    rxSchedulerProvider.main(),
    CommonError::Error
) {
    override fun create(input: Unit): Single<NotificationUiModel> {
        return notificationRepository.getBadgesNotification()
    }
}
