...
@Module
interface CreatePasswordFragmentViewModelModule {

    @FragmentScope
    @Binds
    @IntoMap
    @ViewModelKey(CreatePasswordFragmentViewModel::class)
    fun createPasswordFragmentViewModel(viewModel: CreatePasswordFragmentViewModelImpl): ViewModel
}
