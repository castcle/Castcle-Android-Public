...
@Module
interface CropAvatarImageViewModelModule {

    @FragmentScope
    @Binds
    @IntoMap
    @ViewModelKey(CropAvatarImageFragmentViewModel::class)
    fun cropAvatarImageFragmentViewModel(viewModel: CropAvatarImageFragmentViewModelImpl): ViewModel
}
