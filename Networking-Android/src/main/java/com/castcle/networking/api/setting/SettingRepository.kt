...
import com.castcle.common_model.model.setting.toLanguageUiModel
...
//
//
//  Created by sklim on 28/9/2021 AD at 14:52.
interface SettingRepository {
    fun getMeteLanguage(): Single<List<LanguageUiModel>>
}
...
class SettingRepositoryImpl @Inject constructor(
    ...
    override fun getMeteLanguage(): Single<List<LanguageUiModel>> {
        return languageApi.getMeteLanguage()
            .lift(ApiOperators.mobileApiError())
            .map { it.toLanguageUiModel() }
            .firstOrError()
    }
}
