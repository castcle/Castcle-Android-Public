...
//
//
//  Created by sklim on 23/8/2021 AD at 07:44.

@Module
class NonAuthenticationDataSourceModule {

    @Provides
    fun nonAuthenticationApi(
        @NonAuthentication retrofit: Retrofit
    ): NonAuthenticationApi {
        return retrofit.create(NonAuthenticationApi::class.java)
    }
